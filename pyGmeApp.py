...
class SnkGameClass:
    with open("snkDebug.txt", "a") as fi:
        def gameFun(self, sh, sw, w, snk_x, snk_y, snake, food, key, prevKey, userScore):
            try:
                shpList = [curses.ACS_PI, "+", "O"]
                while True:
                    next_key = w.getch()
                    ...
                    if snake[0] == food:
                        ...
                        w.addch(food[0], food[1], random.choice(shpList))
                    else:
                        tail = snake.pop()
...
if __name__ == "__main__":
    ...
    print(r"          \  \\   | |    ***     / /__\ \     |    \/    |  | |_____")
    print(r"          /  /    | |           /  ____  \    |  |\   /| |  |  _____|")
    print(r"         /  /     | |___|**|   /  /    \  \   |  | \_/ | |  | |_______")
    print(r"        /  /      |_____/| |  /__/      \__\  |__|     |_|  |_________|")
    print(r"       (  (              |_|")
    print(r"        \  \\")
    print(r"          \/")
    with open("snkDebug.txt", "a") as fi:
        ...
        userScore = 0
        myClsObj = SnkGameClass()
        myClsObj.gameFun(sh, sw, w, snk_x, snk_y, snake, food, key, prevKey, userScore)   
